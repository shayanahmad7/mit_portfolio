...
export default function Projects() {
  ...
  const teaching = [
    ...
    },
    {
      ...
      period: "Jun - Nov 2020",
      description: "This transformative experience during my gap year shaped my entire educational philosophy. Taught mathematics to students across grades 4-8, where I encountered Hana—a student who believed she 'couldn't do math.' When traditional methods failed, I discovered she lacked foundational number sense, not intelligence. Implemented video-based flipped classroom model using Khan Academy, freeing up space for everyone to learn at their own pace—struggling students could go all the way back to kindergarten-level content while advanced students pushed ahead. In-class time became collaborative problem-solving and peer support. Organized peer-learning groups where stronger students taught struggling peers. Led daily growth mindset sessions where students shouted together: 'I CAN LEARN ANYTHING!' One of my 4th-graders was able to keep advancing and reached algebraic thinking ahead of schedule. The moment Hana finally grasped multiplication after mastering prerequisites was my epiphany about the power of mastery-based learning—every student can learn, they just need the right support at the right time. This experience convinced me to dedicate my life to building educational tools that scale this personalized approach globally."
    }
  ];
